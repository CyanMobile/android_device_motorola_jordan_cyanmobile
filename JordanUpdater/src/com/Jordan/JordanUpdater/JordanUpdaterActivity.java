package com.Jordan.JordanUpdater;
				...
				if (data != null) {
					...
					if (fileUri != null && !fileUri.toString().equals("")) {
						...
						if (filePath != null) {
							...
							try {
								checkDownloadedMD5.setAction(com.Jordan.JordanUpdater.JordanUpdaterActivity.checkMD5(filePath, true));
							} catch (IOException e) {
								// TODO Auto-generated catch block
								checkDownloadedMD5.setAction(com.Jordan.JordanUpdater.JordanUpdaterActivity.badFilePath());
							}
